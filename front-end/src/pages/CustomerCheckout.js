  ...
  return (
    <div className="checkout-container">
      ...
      <div className="checkout-container-content">
        ...
        <div className="checkout-content-table">
          <OrderTable
        ...
        <div
          className="checkout-content-informations"
        >
          <div className="checkout-content-informations-head">
            <p>P. Vendedora Responsável</p>
            <p>Endereço</p>
            <p>Número</p>
          </div>
          <div className="checkout-content-informations-labels">
